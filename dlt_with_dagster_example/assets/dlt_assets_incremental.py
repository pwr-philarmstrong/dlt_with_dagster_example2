# Single dlt asset created with manual function calls from public postgres database wuth incremental pipeline to duckdb
import yaml
import logging
...
def create_resource(table_name):
    ...
    def resource():
        ...
        ).parallelize().apply_hints(incremental=dlt.sources.incremental(incremental_column))
...
@dlt_assets(
    ...
    name=f"inc_table_{table_name}", 
    group_name="dlt_assets_incremental",
)
