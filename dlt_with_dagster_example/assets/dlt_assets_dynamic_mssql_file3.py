# Multiple dlt assets created with dynamically from sql server database to filesystem with extra columns added and translation function
...
tables = ['dbo.SmoothingFactors', 'dbo.pplDimension', 'dbo.Configuration']
...
class CustomDagsterDltTranslator(DagsterDltTranslator):
    def get_asset_key(self, resource: DagsterDltResource) -> AssetKey:
        ...
        return AssetKey(f"dlt_raw_mssql__{new_asset_name}")
...
def create_dlt_assets(tables):
    ...
    for table_name in tables:
        ...
        unique_asset_name = f"dlt_assets_dynamic_mssql_file3__{table}"
        ...
        def create_asset_function(table_name, unique_asset_name):
            @dlt_assets(
                ...
                dlt_pipeline=pipeline(        
                    ...
                    dataset_name="dlt_assets_dynamic_mssql_file3",
                    progress="log",
                ),
                name=unique_asset_name, 
                group_name="dlt_assets_dynamic_mssql_file3",
